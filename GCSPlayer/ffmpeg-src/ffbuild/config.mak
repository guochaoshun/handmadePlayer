...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix='/Users/uxin/Desktop/无名高地/fileReadAction/GCSPlayer/ffmpeg-build/iphonesimulator_x86_64' --enable-cross-compile --target-os=darwin --arch=x86_64 --cc='xcrun -sdk iphonesimulator clang' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator26.0.sdk --extra-cflags='-arch x86_64 -mios-simulator-version-min=12.0' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=12.0' --disable-programs --disable-doc --disable-debug --disable-everything --enable-avformat --enable-avcodec --enable-swscale --enable-swresample --enable-avutil --enable-decoder=h264 --enable-decoder=aac --enable-demuxer=mov --enable-protocol=file --enable-videotoolbox --enable-audiotoolbox --disable-iconv --disable-network --disable-zlib --disable-bzlib --disable-lzma --disable-x86asm
prefix=/Users/uxin/Desktop/无名高地/fileReadAction/GCSPlayer/ffmpeg-build/iphonesimulator_x86_64
...
CC_IDENT=Apple clang version 17.0.0 (clang-1700.3.19.1)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator26.0.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator26.0.sdk -DPIC
CFLAGS=  -arch x86_64 -mios-simulator-version-min=12.0 -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -arch x86_64 -mios-simulator-version-min=12.0 -fPIC -Qunused-arguments
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -arch x86_64 -mios-simulator-version-min=12.0  --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator26.0.sdk -Wl,-dynamic,-search_paths_first -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator26.0.sdk -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
